<div class="flex flex-col items-center text-center mx-5 py-10">
  <i>
    <svg
  ...
  <div>
    <p class="w-4/5 m-auto text-3xl font-semibold">Akun ini bersifat pribadi</p>
    <p class=" text-gray-500">Ikuti akun ini untuk melihat postingannya</p>
  </div>
</div>
